-- ============================================================================
-- FIX RECURRING POSTS RACE CONDITION
-- ============================================================================
-- Adds atomic locking to prevent duplicate scheduled posts from recurring posts
-- ============================================================================
...
COMMENT ON FUNCTION process_recurring_posts IS 
  'Processes recurring posts with atomic locking to prevent duplicate scheduled posts';

-- Log the migration
DO $$
BEGIN
  RAISE NOTICE '✅ Fixed recurring posts race condition';
  RAISE NOTICE '✅ Added FOR UPDATE SKIP LOCKED to prevent duplicates';
  RAISE NOTICE '✅ Update next_post_date BEFORE creating scheduled post';
END;
$$;
