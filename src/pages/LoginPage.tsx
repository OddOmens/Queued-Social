    ...
    return (
        <div className="min-h-[100dvh] w-full bg-zinc-950 flex flex-col items-center justify-center font-sans overflow-hidden select-none px-0 md:px-6 relative">
            ...
            <div className="w-full max-w-[1200px] h-[100dvh] md:h-[800px] md:max-h-[95vh] md:rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row bg-zinc-900 relative z-10 border-0 md:border md:border-zinc-800">
                ...
                {/* Right Side: Sign In */}
                <div className="w-full md:w-[440px] lg:w-[480px] bg-background text-foreground p-8 md:p-12 lg:p-16 flex flex-col justify-center relative z-20 shrink-0 order-1 md:order-2 h-[100dvh] md:h-full">
                        ...
                        <Card className="border-0 shadow-none bg-transparent">
                            ...
                            <CardContent className="px-0 pb-0 space-y-6">
                                <Button 
                                    size="lg" 
                                    variant="outline"
                                    className="w-full h-12 text-sm font-medium transition-colors flex items-center justify-center gap-3 border-border hover:bg-muted text-zinc-700 shadow-sm"
                                ...
                                <div className="relative flex items-center py-2">
                                    ...
                                    <span className="flex-shrink-0 px-4 text-xs font-semibold text-zinc-400 uppercase tracking-wider">Fast & Secure</span>
                                    <div className="flex-grow border-t border-border"></div>
                                </div>
                                ...
                                <div className="bg-amber-50/80 border border-amber-200 rounded-xl p-5">
                                    <h4 className="flex items-center gap-2 text-sm font-semibold text-amber-900 mb-2">
                                        <AlertTriangle className="h-4 w-4 text-amber-600" /> Work in Progress
                                    </h4>
